...
&emsp;&emsp;3、除上海外，q的估计值对$γ_A$的选择不敏感。在我们所研究的省市中浙江的q值最高，这也与浙江省人民政府所做的显著努力相一致，截至2020年3月2日，该政府已成功追踪了4万多个密切联系者。
...
&ensp; &ensp;&ensp;&ensp;对于每个省市，进行1000次模拟，生成关键人群流行病发展趋势的95%置信区间，其中累计确诊病例数是IH、RH和D的总和。
<div  align="center">    
...
&ensp; &ensp;&ensp;&ensp;流行病传播是由于存在活跃的病毒携带者，因此当活跃的病毒携带者的数量减少到一定水平时，新的感染是有限的，这也意味着流行病得到了控制。所这里定义流行病得到控制的时间为活跃病毒携带者数量首先小于阈值$T_c$。

<div  align="center">    
<img src="image/3.2.2.jpg" width = "950" height = "500" >
</div> 

&ensp; &ensp;&ensp;&ensp;当$T_c=10$时，本研究的六个省市中，上海的最早控制时间预计为2月21日，而广东的最晚控制时间预计为3月7日左右。根据《中国NHC日报》报道，2月17日至2月21日上海市新发感染分别为0、0、0、1、0；同期广东新感染人数为6，3，1，1，6，这可能支持我们的预测。
注意，在对$γ_A$的敏感性分析中，我们发现当无症状患者$γ_A$的恢复率变小时，预期的流行病控制时间变长。
...
&emsp;&emsp;在本研究中，$R_c$的变化通过给定时间段内活跃病毒携带者的流入和流出之间的比率来近似。准确地说，我们定义如下公式。
...
&emsp;&emsp;4、在选定的省份中，在得到控制的情况下传播情况$R_c$在2到3之间，并且自控制措施实施以来显著减少。
...
&emsp;&emsp;2、引入医疗服务能力；

&emsp;&emsp;3、引入城市流动人口。
